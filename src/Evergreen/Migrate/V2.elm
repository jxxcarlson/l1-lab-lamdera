...
accessIdentity old =
    case old of
        Evergreen.V1.Document.Public ->
            Evergreen.V2.Document.Public

        Evergreen.V1.Document.Private ->
            Evergreen.V2.Document.Private

        Evergreen.V1.Document.Shared { canRead, canWrite } ->
            Evergreen.V2.Document.Shared { canRead = canRead, canWrite = canWrite }
