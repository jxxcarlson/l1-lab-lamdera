...
type ToBackend
    ...
    | SaveDocument Evergreen.V19.Document.Document
    | DeleteDocumentById String
    | GetUserDocuments String
    | GetDocumentsWithQuery (Maybe Evergreen.V19.User.User) SearchTerm
    | GetDocumentById String
    | GetDocumentBySlug String
    | GetDocumentByIdForGuest String
    | RegisterNewDocument Evergreen.V19.Document.Document
...
type ToFrontend
    ...
    | LoginGuest
    | SendDocument Evergreen.V19.Document.Document
    | SendDocuments (List Evergreen.V19.Document.Document)
    | SendMessage String
